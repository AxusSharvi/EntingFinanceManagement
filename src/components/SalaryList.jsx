        ...
        {isLoading ? (
          ...
          <div>
            ...
            <div className="md:hidden space-y-4">
              {salaries.map((salary) => (
                <div key={salary.id} className="bg-white p-4 rounded-xl border border-gray-200 shadow">
                  <div className="flex justify-between items-center mb-2">
                    <p className="text-lg font-bold text-green-700">{formatCurrency(salary.monthly_salary)}</p>
                    <div className="flex space-x-2">
                      <button
                        onClick={() => onEdit(salary)}
                        className="text-blue-600 hover:text-blue-900 transition-colors"
                  ...
                  <p className="text-sm text-gray-500">
                    <span className="font-semibold">Date Added:</span> {formatDate(salary.created_at)}
                  </p>
                </div>
              ))}
            </div>
